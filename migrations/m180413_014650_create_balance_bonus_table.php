...
/**
 * Handles the creation of table `balance_bonus`.
 */
class m180413_014650_create_balance_bonus_table extends Migration
{
    /**
     * @var string The table name.
     */
    public $tableName = '{{%balance_bonus}}';
    ...
    public function safeUp()
    {
        ...
        $this->addForeignKey('balance_bonus_fk_1', $this->tableName, 'user_id', '{{%user}}', 'id', 'CASCADE', 'RESTRICT');
    }
