...
/**
 * Handles the creation of table `balance_transaction`.
 */
class m180413_013158_create_balance_transaction_table extends Migration
{
    /**
    ...
    public function safeUp()
    {
        ...
        $this->addForeignKey('balance_transaction_fk_1', $this->tableName, 'user_id', '{{%user}}', 'id', 'CASCADE', 'RESTRICT');
    }
